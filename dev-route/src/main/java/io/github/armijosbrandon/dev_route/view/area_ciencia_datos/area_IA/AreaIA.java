package io.github.armijosbrandon.dev_route.view.area_ciencia_datos.area_IA;
 ...
 * @see ScrollPane
 */
public class AreaIA extends VBox{
    ...
    public AreaIA() {
    	...
    	btnTecnologia1 = Utils.boton("1. Machine Learning", "fas-robot","icono-generico");     
    	btnTecnologia2 = Utils.boton("2. Deep Learning", "fas-network-wired","icono-generico");       
       	
    	// Inicializacion del contenido explicativo detallado
    	scrollInfo1 = crearContenidoInformativo(
		    "Machine Learning\n",
		    "• Qué aprender: Algoritmos supervisados de Regresión (Lineal/Logística) y Clasificación (Árboles de decisión, KNN), división del conjunto de datos en entrenamiento/prueba y métricas de evaluación del modelo (Precisión, Recall).\n• Herramientas clave: Scikit-Learn."
		);
		// btnTecnologia2 = Utils.boton("2. Deep Learning", "fas-network-wired");
		scrollInfo2 = crearContenidoInformativo(
		    "Deep Learning Introductorio\n",
		    "• Qué aprender: Fundamentos de redes neuronales artificiales, capas densas (perceptrón multicapa), funciones de activación (ReLU, Sigmoid), conceptos de retropropagación y entrenamiento de modelos predictivos iniciales.\n• Herramientas clave: TensorFlow y Keras."
		);
