package io.github.armijosbrandon.dev_route.view.area_web.area_fronted_basico;
 ...
 * @see ScrollPane
 */
public class AreaFrontedBasico extends VBox{
     ...
     * </p>
     */
    public AreaFrontedBasico() {
    	
    	this.setSpacing(15);
    	
    	//Inicializacion de los botones
    	btnTecnologia1 = Utils.boton("1. HTML5", "fab-html5","icono-generico","logo-html5");     
    	btnTecnologia2 = Utils.boton("2. CSS3", "fab-css3-alt","icono-generico","logo-css3");       
    	btnTecnologia3 = Utils.boton("3. JavaScript", "fab-js-square","icono-generico","logo-js");    

    	
    	// Inicializacion del contenido explicativo detallado
    	scrollInfo1 = crearContenidoInformativo(
		    "HTML5\n",
		    "• Qué aprender: Estructura semántica del documento (header, section, article, footer), etiquetas de formularios nativos, accesibilidad web básica (A11y) y optimización SEO inicial.\n• Herramientas clave: Validadores de la W3C y DevTools del navegador."
		);
		
		scrollInfo2 = crearContenidoInformativo(
		    "CSS3\n",
		    "• Qué aprender: Modelos de maquetación modernos (Flexbox y CSS Grid), cascada, especificidad de selectores, diseño responsivo usando Media Queries y animaciones de transición fluidas.\n• Herramientas clave: Frameworks utilitarios opcionales como Tailwind CSS."
		);
		
		scrollInfo3 = crearContenidoInformativo(
		    "JavaScript\n",
		    "• Qué aprender: Fundamentos esenciales (variables, funciones flecha, promesas, async/await), manipulación interactiva del DOM, captura de eventos del usuario y peticiones fetch de datos asíncronas.\n• Herramientas clave: JavaScript ES6+ nativo."
		);
