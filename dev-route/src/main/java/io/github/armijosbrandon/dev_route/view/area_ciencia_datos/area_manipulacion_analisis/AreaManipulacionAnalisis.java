package io.github.armijosbrandon.dev_route.view.area_ciencia_datos.area_manipulacion_analisis;
 ...
 * @see ScrollPane
 */
public class AreaManipulacionAnalisis extends VBox{
     ...
     * </p>
     */
    public AreaManipulacionAnalisis() {
    	
    	this.setSpacing(15);
    	
    	//Inicializacion de los botones
    	btnTecnologia1 = Utils.boton("1. Pandas", "fas-file-csv","icono-generico");     
    	btnTecnologia2 = Utils.boton("2. NumPy", "fas-th","icono-generico");       
    	btnTecnologia3 = Utils.boton("3. Visualización", "fas-chart-bar","icono-generico","icono-generico");    

    	
    	// Inicializacion del contenido explicativo detallado
    	scrollInfo1 = crearContenidoInformativo(
		    "Pandas\n",
		    "• Qué aprender: Uso de estructuras fundamentales (Series y DataFrames), limpieza de registros nulos o duplicados, filtrado de datos tabulares indexados y fusión y transformación avanzada de conjuntos de datos.\n• Herramientas clave: Biblioteca Pandas de Python."
		);
		scrollInfo2 = crearContenidoInformativo(
		    "NumPy\n",
		    "• Qué aprender: Manipulación de vectores y matrices multidimensionales (ndarrays), operaciones matemáticas vectorizadas de alta velocidad, indexación booleana y generación de datos numéricos aleatorios.\n• Herramientas clave: Biblioteca NumPy."
		);
		scrollInfo3 = crearContenidoInformativo(
		    "Visualización\n",
		    "• Qué aprender: Creación de gráficos estadísticos esenciales (líneas, barras, dispersión, histogramas), personalización estética de gráficos (colores, etiquetas, leyendas) y diagramas de correlación complejos.\n• Herramientas clave: Matplotlib y Seaborn."
		);
