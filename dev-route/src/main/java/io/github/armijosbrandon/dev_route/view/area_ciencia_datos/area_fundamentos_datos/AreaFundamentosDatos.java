package io.github.armijosbrandon.dev_route.view.area_ciencia_datos.area_fundamentos_datos;
 ...
 * @see ScrollPane
 */
public class AreaFundamentosDatos extends VBox{
     ...
     * </p>
     */
    public AreaFundamentosDatos() {
    	
    	this.setSpacing(15);
    	
    	//Inicializacion de los botones
    	btnTecnologia1 = Utils.boton("1. Python", "fab-python","icono-generico","logo-python");     
    	btnTecnologia2 = Utils.boton("2. SQL", "fas-table","icono-generico");       
    	btnTecnologia3 = Utils.boton("3. Matemáticas", "fas-calculator","icono-generico","icono-generico");    

    	
    	// Inicializacion del contenido explicativo detallado
    	scrollInfo1 = crearContenidoInformativo(
    		    "Python\n",
    		    "• Qué aprender: Sintaxis limpia, estructuras de datos nativas (listas, tuplas, diccionarios), flujos de control (bucles for/while), comprensión de listas y creación de funciones reutilizables.\n• Herramientas clave: Jupyter Notebooks y entornos Anaconda."
		);
		scrollInfo2 = crearContenidoInformativo(
		    "SQL\n",
		    "• Qué aprender: Consultas de extracción (SELECT), filtrado avanzado (WHERE, HAVING), agrupamientos de registros (GROUP BY) y combinaciones relacionales entre múltiples tablas (INNER/LEFT JOIN).\n• Herramientas clave: PostgreSQL, SQLite o MySQL."
		);
		scrollInfo3 = crearContenidoInformativo(
		    "Matemáticas\n",
		    "• Qué aprender: Estadística descriptiva (media, mediana, desviación estándar), distribuciones probabilísticas, álgebra lineal elemental (vectores y matrices) y conceptos clave de cálculo para optimización.\n• Herramientas clave: Fórmulas matemáticas aplicadas al análisis de negocio."
		);
