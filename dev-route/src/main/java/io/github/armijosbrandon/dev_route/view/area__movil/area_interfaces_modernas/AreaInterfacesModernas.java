package io.github.armijosbrandon.dev_route.view.area__movil.area_interfaces_modernas;
 ...
 * @see ScrollPane
 */
public class AreaInterfacesModernas extends VBox{
     ...
     * </p>
     */
    public AreaInterfacesModernas() {
    	
    	this.setSpacing(15);
    	
    	//Inicializacion de los botones
    	btnTecnologia1 = Utils.boton("1. Jetpack Compose (Android) ", "fas-pencil-ruler","icono-generico");     
    	btnTecnologia2 = Utils.boton("2. SwiftUI (iOS)", "fas-vector-square","icono-generico");       
       	
    	// Inicializacion del contenido explicativo detallado
    	scrollInfo1 = crearContenidoInformativo(
		    "Jetpack Compose (Android)\n",
		    "• Qué aprender: Creación de interfaces de usuario puramente declarativas basadas en funciones Composable, gestión y elevación del estado (State Hoisting), listas adaptables dinámicas y animaciones integradas.\n• Herramientas clave: Android Studio Compose Preview."
    	);
	
		scrollInfo2 = crearContenidoInformativo(
		    "SwiftUI (iOS)\n",
		    "• Qué aprender: Paradigma de diseño declarativo para Apple, enlazado de datos mediante modificadores de estado (@State, @Binding, @ObservedObject), transiciones de vistas animadas y layouts adaptables nativos.\n• Herramientas clave: Xcode Live Canvas Preview."
		);
