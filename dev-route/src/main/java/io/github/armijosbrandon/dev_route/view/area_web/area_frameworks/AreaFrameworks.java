package io.github.armijosbrandon.dev_route.view.area_web.area_frameworks;
 ...
 * @see ScrollPane
 */
public class AreaFrameworks extends VBox{
     ...
     * </p>
     */
    public AreaFrameworks() {
    	
    	this.setSpacing(15);
    	
    	//Inicializacion de los botones
    	btnTecnologia1 = Utils.boton("1. Frameworks", "fas-cubes","icono-generico");     
    	btnTecnologia2 = Utils.boton("2. TypeScript", "fas-shield-alt","icono-generico","logo-typescript");       
    	btnTecnologia3 = Utils.boton("3. Manejo de Estado", "fas-project-diagram","icono-generico");    

    	
    	// Inicializacion del contenido explicativo detallado
    	scrollInfo1 = crearContenidoInformativo(
		    "Frameworks (React.js O Vue.js O Angular)\n",
		    "• Qué aprender: Ciclo de vida y estados de los componentes, reutilización de interfaces a través de propiedades (props), renderizado condicional de elementos y enrutamiento interno de páginas (Routing).\n• Herramientas clave: React.js, Vue.js o Angular (elige una tecnología)."
    	);
    	
		scrollInfo2 = crearContenidoInformativo(
		    "TypeScript\n",
		    "• Qué aprender: Sistema de tipado estático (string, number, boolean), definición de interfaces y tipos personalizados, manejo seguro de nulos y tipado estático en funciones y arreglos.\n• Herramientas clave: Compilador TSC e integración directa en tu editor de código."
		);
		
		scrollInfo3 = crearContenidoInformativo(
		    "Manejo de Estado\n",
		    "• Qué aprender: Flujo de datos centralizado, creación de almacenes globales para evitar el traspaso excesivo de propiedades (prop drilling) and persistencia temporal de datos de sesión.\n• Herramientas clave: Redux Toolkit (React), Context API (React) o Pinia (Vue)."
		);
