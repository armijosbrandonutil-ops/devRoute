package io.github.armijosbrandon.dev_route.view.area__movil.area_camino_inicial;
 ...
 * @see ScrollPane
 */
public class AreaCaminoInicial extends VBox{
     ...
     * </p>
     */
    public AreaCaminoInicial() {
    	
    	this.setSpacing(15);
    	
    	//Inicializacion de los botones
    	btnTecnologia1 = Utils.boton("1. Camino Nativo\n   Android (Kotlin) ", "fab-android","icono-generico","logo-android");     
    	btnTecnologia2 = Utils.boton("2. Camino Nativo\n   iOS (Swift)", "fab-apple","icono-generico","logo-apple");       
       	
    	// Inicializacion del contenido explicativo detallado
    	scrollInfo1 = crearContenidoInformativo(
		    "Camino Nativo Android (Kotlin)\n",
		    "• Qué aprender: Sintaxis moderna de Kotlin (seguridad contra nulos, variables mutables/inmutables, lambdas), arquitectura de componentes, gestión del ciclo de vida de la aplicación y concurrencia con Coroutines.\n• Herramientas clave: Android Studio SDK."
    	);
    		
		scrollInfo2 = crearContenidoInformativo(
		    "Camino Nativo iOS (Swift)\n",
		    "• Qué aprender: Fundamentos del lenguaje Swift (opcionales, clausuras, structs vs classes), patrones de delegación, concurrencia nativa (async/await) y empaquetado oficial para la tienda de aplicaciones.\n• Herramientas clave: Xcode de Apple."
		);
