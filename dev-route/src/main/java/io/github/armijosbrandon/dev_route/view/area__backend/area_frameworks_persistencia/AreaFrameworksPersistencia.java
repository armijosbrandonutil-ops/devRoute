package io.github.armijosbrandon.dev_route.view.area__backend.area_frameworks_persistencia;
 ...
 * @see ScrollPane
 */
public class AreaFrameworksPersistencia extends VBox{
     ...
     * </p>
     */
    public AreaFrameworksPersistencia() {
    	
    	this.setSpacing(15);
    	
    	//Inicializacion de los botones
    	btnTecnologia1 = Utils.boton("1. Framework de elección", "fas-rocket","icono-generico","icono-generico");     
    	btnTecnologia2 = Utils.boton("2. Bases de Datos Relacionales", "fas-database","icono-generico","icono-generico");       
    	btnTecnologia3 = Utils.boton("3. ORM (Mapeo Objeto-Relacional)", "fas-exchange-alt","icono-generico","icono-generico");    
    	
    	// Inicializacion del contenido explicativo detallado
    	scrollInfo1 = crearContenidoInformativo(
		    "Framework de elección (Spring Boot / Django / .NET)\n",
		    "• Qué aprender: Enrutamiento y manejo de peticiones HTTP, inyección de dependencias, controladores REST, middleware o filtros de peticiones, e integración directa con capas de persistencia de datos.\n• Herramientas clave: Spring Boot (Java), Django (Python) o .NET Core (C#)."
		);
		scrollInfo2 = crearContenidoInformativo(
		    "Bases de Datos Relacionales (PostgreSQL, MySQL)\n",
		    "• Qué aprender: Modelado entidad-relación, diseño formal de tablas, claves primarias y foráneas, indexación estratégica de columnas para consultas masivas de alto rendimiento y transacciones ACID seguras.\n• Herramientas clave: PostgreSQL o MySQL."
		);
		scrollInfo3 = crearContenidoInformativo(
		    "ORM (Hibernate, Entity Framework o Django ORM)\n",
		    "• Qué aprender: Mapeo de tablas de base de datos a objetos de código (clases entidad), ejecución de migraciones automáticas del esquema de la base de datos, consultas optimizadas y manejo de relaciones complejas (1:N, N:M).\n• Herramientas clave: Hibernate, Entity Framework o Django ORM."
		);
