package io.github.armijosbrandon.dev_route.view.area_web.area_tooling;
 ...
 * @see ScrollPane
 */
public class AreaTooling extends VBox{
    ...
    public AreaTooling() {
    	...
    	btnTecnologia1 = Utils.boton("1. Empaquetadores", "fas-box-open","icono-generico");     
    	btnTecnologia2 = Utils.boton("2. Testing Basico", "fas-vial","icono-generico");       

    	
    	// Inicializacion del contenido explicativo detallado
        scrollInfo1 = crearContenidoInformativo(
    		"Vite o Webpack\n",
    		"• Qué aprender: Configuración básica de entornos, optimización de bundles, transpilación y manejo de assets (imágenes/estilos).\n• Herramientas clave: Vite (recomendado por velocidad) o Webpack (estándar de la industria)."
        );
        scrollInfo2 = crearContenidoInformativo(
        		"Jest o Vitest\n",
        		"• Qué aprender: Pruebas unitarias básicas, aserciones comunes (expect), testing de componentes visuales aislados y simulación de funciones (mocking).\n• Herramientas clave: Jest (clásico en React) o Vitest (nativo para Vite)."
        );
